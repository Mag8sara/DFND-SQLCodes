...
(and pricing) is provided here. Pull these extensions
...
FROM sales_reps;
/*Each company in the accounts table wants to create an email address for each primary_poc. The email address should be the
