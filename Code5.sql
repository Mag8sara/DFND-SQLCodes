/* Write a query to return 15 row */
...
SELECT * FROM orders ORDER BY occurred_at , total_amt_usd  LIMIT 10;
...
SELECT id, account_id , standard_amt_usd/standard_qty as UnitPrice FROM orders LIMIT 10
/*Right answer*/
...
SELECT id, account_id, poster_amt_usd/(standard_amt_usd + gloss_amt_usd + poster_amt_usd) AS post_per FROM orders;
